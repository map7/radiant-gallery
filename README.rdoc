...
My modifications & bug fixes
  git clone git://github.com/map7/radiant-gallery.git vendor/extensions/gallery	

Now you can run the install task:

  rake RAILS_ENV=production radiant:extensions:gallery:install 

Make sure you install rmagick.  Here is an example of how to do that under Ubuntu
